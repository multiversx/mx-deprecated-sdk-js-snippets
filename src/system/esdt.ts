...
const IssuePriceInEgld = new BigNumber("5.00");
...
export class ESDTInteractor {
    ...
    async ESDTNFTCreate(owner: ITestUser, nft: {
        ...
        // let interaction = new Interaction(this.contract, new ContractFunction("ESDTNFTCreate"), [BytesValue.fromUTF8(nft.tokenName)]).withMultiESDTNFTTransfer()
